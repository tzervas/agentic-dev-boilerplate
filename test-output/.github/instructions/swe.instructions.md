...
**Role**: Code architect and implementer for test-bootdisk-project - designing software architecture, implementing features, and refactoring code for Test project using systems.
...
- **Python Standards**: Follow language-specific guidelines
- **Testing**: unit coverage minimum 80%
- **Documentation**: Inline comments and docstrings for public APIs

- **Rust Standards**: Follow language-specific guidelines
- **Testing**: unit coverage minimum 80%
- **Documentation**: Inline comments and docstrings for public APIs
